...
function ej1(){
    ...
    let alumno = new Alumno("Bonifacio", "Garcia", 8, 8,7.5)
    let alumno2 = new Alumno("María", "Romero", 6, 10, 8.5)
    let alumno3 = new Alumno("Amparo", "Perez", 9 , 8 ,9.5)
    // Ahora, podemos instanciar la clase Alumno y crear objetos de Alumno ^

    escribirResultado("Pormedio de notas", alumno.promediarNotas())
...
// Ej 4 - Objeto que emula una cuenta de banco con ingresar() y retirar()
    ...
    function ej4(){
        ...
        escribirResultado("Ingresamos una cantidad con decimales €: ", cuenta.ingresar(0));
...
function ej5(){
    ...
    let ficha = new Ficha()   // Debe retornar '10 km'
    ...
    //escribirResultado("Anotar +10 km: ", ficha.anotarSesion(10));
...
function ej8(){
    ...
    let alumno1 = new Alumno("Fran", "ropero", 12344, 7)
    let alumno2 = new Alumno("bonifacio", "Garcia", 43555, 5)
    let alumno3 = new Alumno("Alfredo", "rodriguez", 23677, 8)
    let alumno4 = new Alumno("Ruben", "palma", 98765, 10)
    // Asignamos notas
    alumno1.calificar(7);
    //alumno2.calificar(5);
    //alumno3.calificar(8);
