...
function convertir(){
    ...
    let arr = descomponer(numDecimal);
...
function procesarArray(arr) {
    ...
    // Unidades: 0, ... 9
    if( char3 == 0 ){ char3 = "" }
    else if( char3 >= 1 & char3 <= 3 ){ char3 = unoRom.repeat(char3) }   // X, XX, XXX
    else if( char3 == 4 ){ char3 = unoRom + cincoRom }          // XL
    else if( char3 == 5 ){ char3 = cincoRom }                              // L
    else if( char3 >= 6 & char3 <= 8 ){
        char2 = cincoRom + unoRom.repeat(Number(char3) - 5)     // LX, LXX, LXXX
    }
    else if( char3 == 9 ){ char3 = unoRom + cincuentaRom }         // XC
