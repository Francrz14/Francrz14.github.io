#%%
def calcular_area_poligono(tipo, base, altura = None):
    if tipo == 'triangulo':
        area = base * altura / 2
    elif tipo == 'cuadrado':
        area = base ** 2
...
area_triangulo = calcular_area_poligono('triangulo', 5, 10)
print('El área del triángulo es:', area_triangulo)

# Cálculo del área de un cuadrado
area_cuadrado = calcular_area_poligono('cuadrado', 5)
print('El área del cuadrado es:', area_cuadrado)

# Cálculo del área de un rectángulo
area_rectangulo = calcular_area_poligono('rectangulo', 5, 10)
